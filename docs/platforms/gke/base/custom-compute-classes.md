...
[Base GKE Accelerated Platform](/platforms/gke/base/README.md) there are some
standard `ComputeClass` resources created in the
...
To view the latest custom resource definition (CRD) for the ComputeClass custom
resource, including all fields and their relationships, refer to the
