...
The
[well-lit](https://github.com/llm-d/llm-d/tree/main/guides/optimized-baseline)
...
- Check the all the deployments
  ...
  optimized-baseline-epp                            1/1     1            1           XX
...
- Check all the resources
  ...
  pod/optimized-baseline-epp-XXXX                         1/1      Running    0          XX
  pod/optimized-baseline-nvidia-gpu-vllm-decode-XXXX      1/1      Running    0          XX
  pod/optimized-baseline-nvidia-gpu-vllm-decode-XXXX      1/1      Running    0          XX

  NAME                                      TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)                    AGE
  service/optimized-baseline-epp            ClusterIP   34.118.230.43    <none>        9002/TCP,9090/TCP,80/TCP   XX
