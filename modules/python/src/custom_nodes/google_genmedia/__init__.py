...
from .storycraft import NODE_CLASS_MAPPINGS as STORYCRAFT_NODE_CLASS_MAPPINGS
from .storycraft import (
    NODE_DISPLAY_NAME_MAPPINGS as STORYCRAFT_NODE_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **STORYCRAFT_NODE_CLASS_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **STORYCRAFT_NODE_DISPLAY_NAME_MAPPINGS,
}
