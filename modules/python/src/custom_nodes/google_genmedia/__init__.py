...
from .chirp3_nodes import NODE_CLASS_MAPPINGS as CHIRP3_NODE_CLASS_MAPPINGS
from .chirp3_nodes import (
    NODE_DISPLAY_NAME_MAPPINGS as CHIRP3_NODE_DISPLAY_NAME_MAPPINGS,
)
...
NODE_DISPLAY_NAME_MAPPINGS = {
    **CHIRP3_NODE_DISPLAY_NAME_MAPPINGS,
