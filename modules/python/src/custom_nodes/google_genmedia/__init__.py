...
from .gemini_flash_image_node import NODE_CLASS_MAPPINGS as GEMINI_FLASH_IMAGE_NODE_CLASS_MAPPINGS
from .gemini_flash_image_node import NODE_DISPLAY_NAME_MAPPINGS as GEMINI_FLASH_IMAGE_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **GEMINI_FLASH_IMAGE_NODE_CLASS_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **GEMINI_FLASH_IMAGE_NODE_DISPLAY_NAME_MAPPINGS
}
