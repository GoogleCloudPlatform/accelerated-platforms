...
api_core_exceptions_mock.GoogleAPICallError = Exception
api_core_exceptions_mock.ResourceExhausted = Exception
api_core_exceptions_mock.ServiceUnavailable = Exception
