...
locals {
  ...
  cloudbuild_cws_image_pipeline_git_token_secret_id = var.cloudbuild_cws_image_pipeline_git_token_secret_id != null ? var.cloudbuild_cws_image_pipeline_git_token_secret_id : "${local.unique_identifier_prefix}-cws-pipeline-image-git-token"
  ...
  #cloudbuild_cws_image_git_repository_id = "projects/${var.project_id}/locations/${var.region}/connections/gc-cloud-workstation-image/repositories/gc-cloud-workstation-image"
}
...
variable "cloudbuild_cws_image_pipeline_git_token_secret_id" {
  default     = null
  description = "The ID of the Secret Manager Git token secret."
  type        = string
}
