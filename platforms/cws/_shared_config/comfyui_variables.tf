...
variable "cws_comfyui_model_bucket_location" {
  default     = null
  description = "Location of the ComfyUI models bucket."
  type        = string
}

variable "cws_comfyui_model_bucket_name" {
  default     = null
  description = "Name of the bucket to use for ComfyUI models."
  type        = string
}

variable "cws_comfyui_model_bucket_project_id" {
  default     = null
  description = "Project ID of ComfyUI models bucket."
  type        = string
}
