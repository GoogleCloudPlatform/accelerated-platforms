...
variable "workstation_cluster_name" {
  default     = null
  description = "The name of the Cloud Workstation cluster."
  type        = string
}

variable "workstation_cluster_project_id" {
  default     = null
  description = "The GCP project where the Cloud Workstation cluster will be created."
  type        = string
}

variable "workstation_cluster_region" {
  default     = null
  description = "Region where the Cloud Workstation will be created."
  type        = string
}
