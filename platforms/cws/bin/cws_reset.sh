...
gcloud storage rm -r "gs://${terraform_bucket_name}/terraform/cws" &&
...
git restore \
  "${ACP_PLATFORM_DIR}/_shared_config"/*.auto.tfvars \
  "${ACP_PLATFORM_DIR}/_shared_config/initialize/backend.tf.bucket"
