...
MLP_POSTGRESDB_ADMIN_IAM="${local.postgresdb_database_admin_iam_user}"
MLP_POSTGRESDB_ADMIN_KSA="${local.postgresdb_database_admin_ksa}"
MLP_POSTGRESDB_INSTANCE_URI="${google_sql_database_instance.mlflow_instance_prod.self_link}"
MLP_POSTGRESDB_CONNECTION_STRING="${google_sql_database_instance.mlflow_instance_prod.connection_name}"
MLP_POSTGRESDB_USER_IAM="${local.postgresdb_user_iam_user}"
MLP_POSTGRESDB_USER_KSA="${local.postgresdb_user_ksa}"
