...
locals {
  ...
  huggingface_hub_models_bucket_name                            = var.huggingface_hub_models_bucket_name != null ? var.huggingface_hub_models_bucket_name : "${local.unique_identifier_prefix}-huggingface-hub-models"
