...
locals {
  ...
  network_cluster_subnet_proxy_name = var.network_cluster_subnet_proxy_name != null ? var.network_cluster_subnet_proxy_name : "${local.subnetwork_name}-proxy"
...
variable "network_cluster_subnet_ip_cidr_range" {
  default = {
...
variable "network_region_proxy_ip_cidr_range" {
