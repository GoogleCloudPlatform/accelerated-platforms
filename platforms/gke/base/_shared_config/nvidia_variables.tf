...
locals {
  nvidia_ncg_api_key_secret_manager_project_id  = var.nvidia_ncg_api_key_secret_manager_project_id != null ? var.nvidia_ncg_api_key_secret_manager_project_id : var.cluster_project_id
  ...
  nvidia_nim_model_store_bucket_name       = var.nvidia_nim_model_store_bucket_name != null ? var.nvidia_nim_model_store_bucket_name : "${local.nvidia_nim_model_store_bucket_project_id}-${local.unique_identifier_prefix}-nvidia-nim-model-store"
  nvidia_nim_model_store_bucket_project_id = var.nvidia_nim_model_store_bucket_project_id != null ? var.nvidia_nim_model_store_bucket_project_id : var.cluster_project_id
}
