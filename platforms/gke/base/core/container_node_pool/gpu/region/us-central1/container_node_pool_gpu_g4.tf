...
# resource "google_container_node_pool" "gpu_g4x2_rtx_s96_dws" {
#   # Variables
#   cluster  = data.google_container_cluster.cluster.name
#   location = local.cluster_region
#   name     = "gpu-g4x2-rtx-s96-dws"
#   node_locations = [
#     "us-central1-a",
#     "us-central1-b",
#     "us-central1-c"
...
resource "google_container_node_pool" "gpu_g4x2_rtx_s96_res" {
  # Variables
  cluster  = data.google_container_cluster.cluster.name
  location = local.cluster_region
  name     = "gpu-g4x2-rtx-s96-res"
  node_locations = [
    "us-central1-a",
    "us-central1-b",
    "us-central1-c"
...
resource "google_container_node_pool" "gpu_g4x2_rtx_s96_spot" {
  # Variables
  cluster  = data.google_container_cluster.cluster.name
  location = local.cluster_region
  name     = "gpu-g4x2-rtx-s96-spot"
  node_locations = [
    "us-central1-a",
    "us-central1-b",
    "us-central1-c"
