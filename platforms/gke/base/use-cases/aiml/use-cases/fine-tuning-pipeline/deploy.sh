...
declare -a CORE_TERRASERVICES_APPLY=("networking" "container_cluster" "container_node_pool" "gke_enterprise/fleet_membership" "workloads/cluster_credentials" "workloads/kueue")
