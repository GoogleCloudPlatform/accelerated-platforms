...
declare -a aiml_terraservices=("pipelines/fine-tuning" "initialize")
...
if [ "${ACP_TEARDOWN_CORE_PLATFORM}" = "true" ]; then
    declare -a CORE_TERRASERVICES_DESTROY=("workloads/kueue" "workloads/cluster_credentials" "gke_enterprise/fleet_membership" "container_node_pool" "container_cluster" "networking")
