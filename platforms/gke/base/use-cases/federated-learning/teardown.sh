...
terraform -chdir="${FEDERATED_LEARNING_USE_CASE_TERRAFORM_DIR}/container_image_repository" destroy -auto-approve

rm -rf \
  "${FEDERATED_LEARNING_USE_CASE_TERRAFORM_DIR}/container_image_repository/.terraform"
