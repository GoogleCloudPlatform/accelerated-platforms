...
resource "google_compute_instance_template" "instance_template" {
  for_each = var.federated_learning_confidential_space_workloads
  project  = var.cluster_project_id
  region   = var.cluster_region
  ...
  disk {
    ...
    source_image = var.federated_learning_confidential_space_instance_image_name
  ...
  metadata = {
    ...
    tee-impersonate-service-accounts = var.federated_learning_cross_device_allowed_operator_service_accounts
