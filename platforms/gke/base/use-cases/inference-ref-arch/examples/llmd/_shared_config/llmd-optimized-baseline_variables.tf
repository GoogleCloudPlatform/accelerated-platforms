...
variable "llmd_ob_router_chart_repo" {
...
variable "llmd_ob_skip_router_render_tests" {
  default     = false
  description = "If set, tests will not be rendered. By default, tests are rendered."
  type        = bool
}

variable "llmd_ob_validate_router_manifests" {
  default     = false
