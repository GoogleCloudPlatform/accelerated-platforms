...
locals {
  llmd_plr_gateway_remote_manifest      = "${var.llmd_plr_git_url}/${var.llmd_plr_git_org}/${var.llmd_plr_git_repo}//guides/recipes/gateway/${var.llmd_plr_gateway_type}?ref=${var.llmd_plr_git_branch}"
  llmd_plr_router_base_helm_values      = "${var.llmd_plr_git_raw_url_prefix}/${var.llmd_plr_git_org}/${var.llmd_plr_git_repo}/${var.llmd_plr_git_branch}/guides/recipes/router/base.values.yaml"
  llmd_plr_router_feature_helm_values   = "${var.llmd_plr_git_raw_url_prefix}/${var.llmd_plr_git_org}/${var.llmd_plr_git_repo}/${var.llmd_plr_git_branch}/guides/recipes/router/features/httproute-flags.yaml"
...
variable "llmd_plr_git_raw_url_prefix" {
  default     = "https://raw.githubusercontent.com"
  description = "Prefix to the git url for llmd repo"
  type        = string
}

variable "llmd_plr_git_url" {
  default     = "https://github.com"
  description = "Prefix to the git url for llmd repo"
  type        = string
}

variable "llmd_plr_git_branch" {
  default     = "main"
  description = "Branch of the llmd repository."
  type        = string
}

variable "llmd_plr_git_org" {
  default     = "llm-d"
  description = "GitHub Organization where llmd repo is created."
  type        = string
}

variable "llmd_plr_git_repo" {
  default     = "llm-d"
  description = "Name of GitHub repository."
  type        = string
}

variable "llmd_plr_gateway_type" {
  default     = "gke-l7-rilb"
  description = "Gateway type for llmd"
  type        = string
}
variable "llmd_plr_guide_name" {
  default     = "predicted-latency-routing"
  description = "llmd guide name."
  type        = string
}

variable "llmd_plr_kubernetes_version_router_templates" {
  default     = "1.28.0"
...
variable "llmd_plr_router_chart_repo" {
...
variable "llmd_plr_skip_router_render_tests" {
  default     = false
  description = "If set, tests will not be rendered. By default, tests are rendered."
  type        = bool
}

variable "llmd_plr_slo_header_support" {
  default     = false
  description = "Assumes x-llm-d-slo-ttft-ms / x-llm-d-slo-tpot-ms are set on requests"
  type        = bool
}

variable "llmd_plr_validate_router_manifests" {
  default     = false
