...
#   )
#   file_permission = "0644"
#   filename        = "${local.namespace_directory}/${local.ira_online_gpu_kubernetes_namespace_name}/model_server/modelserver_sa.yaml"
# }
...
#   error_on_delete_failure     = false
#   kubeconfig_file             = data.local_file.kubeconfig.filename
#   manifest                    = "${local.namespace_directory}/${local.ira_online_gpu_kubernetes_namespace_name}/model_server/modelserver_sa.yaml"
#   manifest_includes_namespace = true
# }

# resource "google_project_iam_member" "workload_identity_secret_access" {
#   depends_on = [module.kubectl_apply_llmd_ms_sa]
#   member     = "${local.workload_identity_principal_prefix}/ns/${local.ira_online_gpu_kubernetes_namespace_name}/sa/${local.llmd_modelserver_sa}"
...
#   )
#   file_permission = "0644"
#   filename        = "${local.namespace_directory}/${local.ira_online_gpu_kubernetes_namespace_name}/model_server/modelserver_deployment.yaml"
# }
...
#   error_on_delete_failure     = false
#   kubeconfig_file             = data.local_file.kubeconfig.filename
#   manifest                    = "${local.namespace_directory}/${local.ira_online_gpu_kubernetes_namespace_name}/model_server/modelserver_deployment.yaml"
#   manifest_includes_namespace = true
# }
