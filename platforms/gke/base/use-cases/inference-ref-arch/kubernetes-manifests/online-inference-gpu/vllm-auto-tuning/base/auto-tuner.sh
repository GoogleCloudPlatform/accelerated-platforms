...
# 3. Run Optimization
# Explicitly end the command with a semicolon to prevent argument bleeding
...
paths_to_upload = {
    '/tmp/results': 'vllm-tuning/${MODEL_ID}/artifacts',
    '/shared/db': 'vllm-tuning/${MODEL_ID}/database'
}
