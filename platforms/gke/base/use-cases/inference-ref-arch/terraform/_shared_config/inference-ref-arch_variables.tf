...
locals {
  ...
  ira_async_cpu_load_generator_image_url                       = var.ira_async_cpu_load_generator_image_url != null ? var.ira_async_cpu_load_generator_image_url : "${local.cloudbuild_ar_image_repository_url}/cpu/async-load-generator:latest"
  ira_async_cpu_load_generator_kubernetes_namespace_name       = var.ira_async_cpu_load_generator_kubernetes_namespace_name != null ? var.ira_async_cpu_load_generator_kubernetes_namespace_name : "${local.unique_identifier_prefix}-async-load-generator-cpu"
  ira_async_cpu_load_generator_kubernetes_service_account_name = var.ira_async_cpu_load_generator_kubernetes_service_account_name != null ? var.ira_async_cpu_load_generator_kubernetes_service_account_name : "${local.unique_identifier_prefix}-async-load-generator-cpu"

  ira_async_cpu_pubsub_subscriber_image_url                       = var.ira_async_cpu_pubsub_subscriber_image_url != null ? var.ira_async_cpu_pubsub_subscriber_image_url : "${local.cloudbuild_ar_image_repository_url}/cpu/async-pubsub-subscriber:latest"
  ira_async_cpu_pubsub_subscriber_kubernetes_namespace_name       = var.ira_async_cpu_pubsub_subscriber_kubernetes_namespace_name != null ? var.ira_async_cpu_pubsub_subscriber_kubernetes_namespace_name : "${local.unique_identifier_prefix}-async-pubsub-subscriber-cpu"
  ira_async_cpu_pubsub_subscriber_kubernetes_service_account_name = var.ira_async_cpu_pubsub_subscriber_kubernetes_service_account_name != null ? var.ira_async_cpu_pubsub_subscriber_kubernetes_service_account_name : "${local.unique_identifier_prefix}-async-pubsub-subscriber-cpu"

  ira_async_gpu_kubernetes_namespace_name       = var.ira_async_gpu_kubernetes_namespace_name != null ? var.ira_async_gpu_kubernetes_namespace_name : "${local.unique_identifier_prefix}-batch-gpu"
  ira_async_gpu_kubernetes_service_account_name = var.ira_async_gpu_kubernetes_service_account_name != null ? var.ira_async_gpu_kubernetes_service_account_name : "${local.unique_identifier_prefix}-batch-gpu"
  ira_async_gpu_vllm_image_url                  = var.ira_async_gpu_vllm_image_url != null ? var.ira_async_gpu_vllm_image_url : "${local.cloudbuild_ar_image_repository_url}/vllm/batch-gpu:latest"

  ira_async_pubsub_prompt_messages_subscription_dead_letter_name = var.ira_async_pubsub_prompt_messages_subscription_dead_letter_name != null ? var.ira_async_pubsub_prompt_messages_subscription_dead_letter_name : "${local.unique_identifier_prefix}-prompt-messages-subscription-dead-letter"
  ira_async_pubsub_prompt_messages_subscription_name             = var.ira_async_pubsub_prompt_messages_subscription_name != null ? var.ira_async_pubsub_prompt_messages_subscription_name : "${local.unique_identifier_prefix}-prompt-messages-subscription"
  ira_async_pubsub_prompt_messages_topic_dead_letter_name        = var.ira_async_pubsub_prompt_messages_topic_dead_letter_name != null ? var.ira_async_pubsub_prompt_messages_topic_dead_letter_name : "${local.unique_identifier_prefix}-prompt-messages-topic-dead-letter"
  ira_async_pubsub_prompt_messages_topic_name                    = var.ira_async_pubsub_prompt_messages_topic_name != null ? var.ira_async_pubsub_prompt_messages_topic_name : "${local.unique_identifier_prefix}-prompt-messages-topic"
