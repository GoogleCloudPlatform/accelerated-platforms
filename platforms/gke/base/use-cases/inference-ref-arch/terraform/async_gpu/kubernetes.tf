...
locals {
  ...
  workloads = {
    ira_async_gpu = {
      directory       = "${local.namespaces_directory}/${local.ira_async_gpu_kubernetes_namespace_name}"
      namespace       = local.ira_async_gpu_kubernetes_namespace_name
      service_account = local.ira_async_gpu_kubernetes_service_account_name
    }
    ira_async_cpu_pubsub_subscriber = {
      directory       = "${local.namespaces_directory}/${local.ira_async_cpu_pubsub_subscriber_kubernetes_namespace_name}"
      namespace       = local.ira_async_cpu_pubsub_subscriber_kubernetes_namespace_name
      service_account = local.ira_async_cpu_pubsub_subscriber_kubernetes_service_account_name
    }
    ira_async_cpu_load_generator = {
      directory       = "${local.namespaces_directory}/${local.ira_async_cpu_load_generator_kubernetes_namespace_name}"
      namespace       = local.ira_async_cpu_load_generator_kubernetes_namespace_name
      service_account = local.ira_async_cpu_load_generator_kubernetes_service_account_name
    }
  }
