...
resource "google_pubsub_topic" "prompt_messages_topic" {
  ...
  name = local.ira_async_pubsub_prompt_messages_topic_name
}

resource "google_pubsub_topic" "prompt_messages_topic_dead_letter" {
  project = data.google_project.cluster.project_id

  name = local.ira_async_pubsub_prompt_messages_topic_dead_letter_name
}

resource "google_pubsub_subscription" "prompt_messages_subscription" {
  project = data.google_project.cluster.project_id

  name  = local.ira_async_pubsub_prompt_messages_subscription_name
...
resource "google_pubsub_subscription" "prompt_messages_dead_letter_subscription" {
  ...
  name  = local.ira_async_pubsub_prompt_messages_subscription_dead_letter_name
