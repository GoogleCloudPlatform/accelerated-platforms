...
locals {
  ...
  ira_online_tpu_maxdiffusion_sdxl_image_url     = var.ira_online_tpu_maxdiffusion_sdxl_image_url != null ? var.ira_online_tpu_maxdiffusion_sdxl_image_url : "${local.cloudbuild_ar_image_repository_url}/max-diffusion-sdxl:latest"
...
variable "ira_online_tpu_maxdiffusion_sdxl_image_url" {
  default     = null
  description = "The URL for the Max Diffusion SDXL container image."
  type        = string
}
