...
resource "local_file" "llm-d_spc_yaml" {
  ...
  filename        = "${local.namespace_directory}/${var.llm-d_kubernetes_namespace}/model_server/secretproviderclass.yaml"
}

module "kubectl_apply_llm-d_spc" {
  depends_on = [
    local_file.llm-d_spc_yaml,
  ...
  manifest                    = "${local.namespace_directory}/${var.llm-d_kubernetes_namespace}/model_server/secretproviderclass.yaml"
  manifest_includes_namespace = true
}

#Create Service Account for model server
resource "local_file" "llm-d_ms_sa_yaml" {
  content = templatefile(
  ...
  file_permission = "0644"
  filename        = "${local.namespace_directory}/${var.llm-d_kubernetes_namespace}/model_server/modelserver_sa.yaml"
}

module "kubectl_apply_llm-d_ms_sa" {
  depends_on = [
    local_file.llm-d_ms_sa_yaml,
    module.kubectl_apply_llm-d_spc
  ]
  source = "../../../../modules/kubectl_apply"
  ...
  error_on_delete_failure     = false
  kubeconfig_file             = data.local_file.kubeconfig.filename
  manifest                    = "${local.namespace_directory}/${var.llm-d_kubernetes_namespace}/model_server/modelserver_sa.yaml"
  manifest_includes_namespace = true
}
...
resource "local_file" "llm-d_ms_yaml" {
  ...
  file_permission = "0644"
  filename        = "${local.namespace_directory}/${var.llm-d_kubernetes_namespace}/model_server/modelserver_deployment.yaml"
}

module "kubectl_apply_llm-d_ms" {
  depends_on = [
    local_file.llm-d_ms_yaml,
    module.kubectl_apply_llm-d_ms_sa
  ]
  source = "../../../../modules/kubectl_apply"
  ...
  error_on_delete_failure     = false
  kubeconfig_file             = data.local_file.kubeconfig.filename
  manifest                    = "${local.namespace_directory}/${var.llm-d_kubernetes_namespace}/model_server/modelserver_deployment.yaml"
  manifest_includes_namespace = true
}
