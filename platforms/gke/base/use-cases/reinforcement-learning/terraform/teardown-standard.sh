...
export ACP_PLATFORM_USE_CASE_DIR="${ACP_PLATFORM_BASE_DIR}/use-cases/reinforcement-learning"
...
echo "reinforcement-learning teardown total runtime: $(date -d@${total_runtime_value} -u +%H:%M:%S)"
