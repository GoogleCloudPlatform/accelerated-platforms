...
locals {
  image_destination = local.mft_fine_tuning_image_url
  image_directory   = "container-images/cpu/mft-fine-tuning/pytorch/"
  source_folder     = "${local.acp_root}/container-images/cpu/mft-fine-tuning/pytorch/src"
}
