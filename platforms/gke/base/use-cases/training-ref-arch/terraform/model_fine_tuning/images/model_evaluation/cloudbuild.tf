...
locals {
  image_destination = local.mft_model_evaluation_image_url
  image_directory   = "container-images/cpu/mft-model-evaluation/"
  source_folder     = "${local.acp_root}/container-images/cpu/mft-model-evaluation/src"
}
