...
locals {
  ...
  workloads = {
    sft_tpu_maxtext_multi_host = {
      directory       = "${local.namespaces_directory}/${local.sft_tpu_maxtext_multi_host_kubernetes_namespace_name}"
      namespace       = local.sft_tpu_maxtext_multi_host_kubernetes_namespace_name
      service_account = local.sft_tpu_maxtext_multi_host_kubernetes_service_account_name
    }
  }
