...
locals {
  wi_member_principal_prefix = "principal://iam.googleapis.com/projects/${data.google_project.cluster.number}/locations/global/workloadIdentityPools/${data.google_project.cluster.project_id}.svc.id.goog/subject/ns/${local.sft_tpu_maxtext_single_host_kubernetes_namespace_name}/sa/${local.sft_tpu_maxtext_single_host_kubernetes_service_account_name}"
}
