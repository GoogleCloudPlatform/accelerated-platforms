...
coverage_dirs=("accelerated-platforms/use-cases/model-fine-tuning-pipeline/data-processing/ray/tests/")
...
source_dirs=("accelerated-platforms/use-cases/model-fine-tuning-pipeline/data-processing/ray")
