...
> NOTE: If you did not execute the data preparation example, follow [these instructions](/use-cases/data-preqreqs#prepared-data) to load the model into the bucket.
