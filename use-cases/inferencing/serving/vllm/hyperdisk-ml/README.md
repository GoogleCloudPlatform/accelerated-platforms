...
> NOTE: If you did not execute the fine-tuning example, follow [these instructions](/use-cases/data-preqreqs#fine-tuned-model) to load the model into the bucket.
