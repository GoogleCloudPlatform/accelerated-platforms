...
class TestDataCleaner(unittest.TestCase):
    ...
    def test_process_data(self):
        ...
        with unittest.mock.patch(
            ...
            DataPreprocessor, "get_product_image"
        ) as mock_get_product_image, unittest.mock.patch.object(
            DataPreprocessor, "prep_product_desc"
        ) as mock_prep_product_desc, unittest.mock.patch.object(
            DataPreprocessor, "prep_cat"
        ) as mock_prep_cat:
