...
TEXT_API_ENDPOINT = "http://34.171.174.67/embeddings"  # Replace with your actual text embedding API endpoint
    ...
    def _get_text_embedding(self, text: str) -> List[float]:
        ...
        try:
            ...
            response = requests.post(
                TEXT_API_ENDPOINT,
                json={"caption": text},  # Changed "text" to "inputs"
                headers={
            ...
            return EmbeddingResponse.model_validate(text_embeddings).text_embeds
...
async def get_text_embedding(request: TextRequest):
    ...
    try:
        ...
        # return embedding
        return EmbeddingResponse(text_embeds=embedding)
