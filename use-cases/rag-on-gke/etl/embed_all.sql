select pg_background_launch('insert into flipkart_multi
select
uniq_id,
...
from (select uniq_id, google_ml.multimodal_embedding(''multimodal-blip2'', description, image_uri) as mme from flipkart
