...
def create_database(database, new_database, logger):
...
def create_and_populate_table(database, table_name, processed_data_path, logger):
    ...
    try:
        ...
        logger.error(f"Error: CSV file not found at {processed_data_path}")

    except pd.errors.EmptyDataError:
        logger.error("Error: Input CSV file is empty.")
